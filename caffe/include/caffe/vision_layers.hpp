...
template <typename Dtype>
class HashFusionLayer : public Layer<Dtype> {
 public:
  explicit HashFusionLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}

  virtual inline const char* type() const { return "HashFusion"; }
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
			  const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
		       const vector<Blob<Dtype>*>& top){
 ...
 protected:
  ...
  int patch_num_;
  int patch_dim_;
  int out_dim_each_img_;
  int patch_num_each_img_;
  //each goup of patch includes img_num_ images
  int label_num_;
 
};

template <typename Dtype>
class FusionLayer : public Layer<Dtype> {
 public:
  explicit FusionLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}

  virtual inline const char* type() const { return "Fusion"; }
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
			  const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
		       const vector<Blob<Dtype>*>& top){
...
template <typename Dtype>
class WeightedSumPoolingLayer : public Layer<Dtype> {
 public:
  explicit WeightedSumPoolingLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "WeightedSumPooling"; }
...
template <typename Dtype>
class LstmWeightedSumPoolingLayer : public Layer<Dtype> {
 public:
  explicit LstmWeightedSumPoolingLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "LstmWeightedSumPooling"; }
  virtual inline int ExactNumBottomBlobs() const { return 2; }
  virtual inline int ExactNumTopBlobs() const { return 1; }
...
template <typename Dtype>
class WeightedLayer : public Layer<Dtype> {
 public:
  explicit WeightedLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "Weighted"; }
  virtual inline int ExactNumBottomBlobs() const { return 2; }
  virtual inline int ExactNumTopBlobs() const { return 1; }
 ...
 protected:
  ...
  template <typename Dtype>
  class FCWeightedLayer : public Layer<Dtype> {
  public:
    explicit FCWeightedLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
    virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
			    const vector<Blob<Dtype>*>& top);
    virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
    ...
    virtual inline const char* type() const { return "FCWeighted"; }
    virtual inline int ExactNumBottomBlobs() const { return 2; }
    virtual inline int ExactNumTopBlobs() const { return 1; }
...
template  <typename Dtype>
class DropWeightLayer : public Layer<Dtype> {
 public:
  /**
   * @param param provides DropoutParameter dropout_param,
   *     with DropWeightLayer options:
   *   - dropout_ratio (\b optional, default 0.5).
   *     Sets the probability @f$ p @f$ that any given unit is dropped.
   */
  explicit DropWeightLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "DropWeight"; }
