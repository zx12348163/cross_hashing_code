...
void TripletRankLossLabelLayer<Dtype>::Forward_gpu(
...
template <typename Dtype>
void TripletRankLossLabelLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(TripletRankLossLabelLayer);
