...
void LambdaTripletRankLossLayer<Dtype>::Forward_gpu(
...
template <typename Dtype>
void LambdaTripletRankLossLayer<Dtype>::Backward_gpu(const vector<Blob<Dtype>*>& top,
...
INSTANTIATE_LAYER_GPU_FUNCS(LambdaTripletRankLossLayer);
