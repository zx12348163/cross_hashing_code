...
void LstmV2Layer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  LstmV2Parameter lstm_v2_param = this->layer_param_.lstm_v2_param();
  CHECK((lstm_v2_param.has_num_cells()))
      << "lstm_unit_param.has_num_cells()";
  CHECK((lstm_v2_param.has_input_weight_filler()))
      << "lstm_unit_param.has_input_weight_filler()";
  CHECK((lstm_v2_param.has_input_gate_weight_filler()))
      << "lstm_unit_param.has_input_gate_weight_filler()";
  CHECK((lstm_v2_param.has_forget_gate_weight_filler()))
      << "lstm_unit_param.has_forget_gate_weight_filler()";
  CHECK((lstm_v2_param.has_output_gate_weight_filler()))
      << "lstm_unit_param.has_output_gate_weight_filler()";
  // LOG(INFO) << lstm_unit_param.output_gate_weight_filler();
  channels_ = lstm_v2_param.num_cells();
...
void LstmV2Layer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  CHECK((this->layer_param_.bottom_size() == 2
      || this->layer_param_.bottom_size() == 1
